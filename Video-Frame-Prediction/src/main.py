...
def train(local_rank, cfg):
    ...
    train_set = MovingMNIST(
        root="/content/drive/MyDrive/checkPix/Video-Frame-Prediction/data/",
        train=True,
        download=True,
    ...
    start_epoch = 0
    if os.path.isfile("/content/drive/MyDrive/checkPix/Video-Frame-Prediction/model/model.pt"):
        print("Restarting training...")
        checkpoint = torch.load("/content/drive/MyDrive/checkPix/Video-Frame-Prediction/model/model.pt")
        ...
        for step, [past_frames, true_future_frames] in enumerate(train_loader):
            ...
            if main_worker:
                if (step + 1) % print_freq == 0:
                    ...
                    os.makedirs(f"/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/{current_step:06d}", exist_ok=True)

                    plt.imsave(
                        f"/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/{current_step:06d}/train_feed_seq.png", past_frames.cpu().permute(1, 2, 0).numpy()
                    )
                    plt.imsave(
                        f"/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/{current_step:06d}/train_gt_seq.png",
                        true_future_frames.cpu().permute(1, 2, 0).numpy(),
                    )
                    plt.imsave(
                        f"/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/{current_step:06d}/train_pred_seq.png",
                        pred_future_frames.detach().cpu().permute(1, 2, 0).numpy(),
                    )
                    plt.imsave(
                        f"/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/{current_step:06d}/test_feed_seq.png",
                        past_frames_test.cpu().permute(1, 2, 0).numpy(),
                    )
                    plt.imsave(
                        f"/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/{current_step:06d}/test_gt_seq.png",
                        true_future_frames_test.cpu().permute(1, 2, 0).numpy(),
                    )
                    plt.imsave(
                        f"/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/{current_step:06d}/test_pred_seq.png",
                    ...
                    torch.save(
                        ...
                        "/content/drive/MyDrive/checkPix/Video-Frame-Prediction/model/model.pt",
                    )
    ...
    if main_worker:
        with open("/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/train_loss_list.pkl", "wb") as f:
            pickle.dump(train_loss_list, f)
        with open("/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/test_loss_list.pkl", "wb") as f:
            pickle.dump(test_loss_list, f)

        with open("/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/train_metric_list.pkl", "wb") as f:
            pickle.dump(train_metric_list, f)
        with open("/content/drive/MyDrive/checkPix/Video-Frame-Prediction/results/test_metric_list.pkl", "wb") as f:
